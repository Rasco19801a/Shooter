...
import { collide, trySlide, resolveEnemyOverlaps } from './physics.js';
import { visible } from './visibility.js';
import { spawnProjectile } from './combat.js';
import { isWall, BASE_MAP, idx } from './map.js';
...
export function update(state, dt, setHud){
  ...
  if(BASE_MAP[idx(gx,gy)]===2){ state.won=true; setHud(h=>({...h, msg:'Level complete!'})); }
}